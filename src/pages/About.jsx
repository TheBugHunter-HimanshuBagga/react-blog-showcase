...
export default function About() {
  return (
    <div className="p-8 max-w-3xl mx-auto">
      ...
      <p>
        You can reach me at <a href="baggahimanshu311@gmail.com" className="text-sky-500">Email me at</a>
        Github <a href = "https://github.com/TheBugHunter-HimanshuBagga" className="text-sky-500">Visit My github</a>
        LinkedIn<a href = "https://www.linkedin.com/in/himanshu-bagga-30b747323/" className="text-sky-500">Follow me at LinkedIn</a>
      </p>
    </div>
  );
}
